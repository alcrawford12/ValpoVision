...
cv2.createTrackbar('hmin', 'HueComp',74,179,nothing)
cv2.createTrackbar('hmax', 'HueComp',91,179,nothing)
 
cv2.createTrackbar('smin', 'SatComp',71,255,nothing)
cv2.createTrackbar('smax', 'SatComp',186,255,nothing)
